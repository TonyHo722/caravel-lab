...
module edge_detect_tb #( parameter BITS=32,
...
*/
  ...
  spiflash #(.FILENAME("edge_detect.hex")) spiflash ( .csb(flash_csb),
                                              .clk(flash_clk),
                                              .io0(flash_io0),
                                              .io1(flash_io1),
                                              .io2(),          // not used
  ...
  task init_fpga_as;
    begin
        ...
        wait(uut.mprj.mprj.u_fsic.U_IO_SERDES0.rxen);
...
task fpga_axis_req;
    ...
    // 4. [testbech] fpga check AA_MailBox_Reg_Offset + 4 = value
        ...
        wait(uut.mprj.mprj.u_fsic.U_AXIL_AXIS0.axi_ctrl_logic.aa_regs[0][0]); //wait interrupt enable bit = 1
...
//  `include "fsic_coreclk_phase_cnt.v"
