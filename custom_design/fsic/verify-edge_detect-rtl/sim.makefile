...
ifeq ($(SIM),RTL)
    ifeq ($(CONFIG),caravel_user_project)
		...
		iverilog -Ttyp -DFUNCTIONAL -DSIM -DUSE_POWER_PINS -DUNIT_DELAY=#1 -DUSE_EDGEDETECT_IP -DUSER_PROJECT_SIDEBAND_SUPPORT \
        -g2012 \
...
ifeq ($(SIM),GL)
    ifeq ($(CONFIG),caravel_user_project)
		iverilog -Ttyp -DFUNCTIONAL -DGL -DSIM -DUSE_POWER_PINS -DUNIT_DELAY=#1 -DUSE_EDGEDETECT_IP -DUSER_PROJECT_SIDEBAND_SUPPORT \
        -g2012 \
...
ifeq ($(SIM),GL_SDF)
    ifeq ($(CONFIG),caravel_user_project)
		cvc64  +interp \
		+define+SIM +define+FUNCTIONAL +define+GL +define+USE_POWER_PINS +define+UNIT_DELAY +define+ENABLE_SDF +define+USE_EDGEDETECT_IP +define+USER_PROJECT_SIDEBAND_SUPPORT \
